...
export const TOOL_DEFS = {
  ...
  spork: {
    id: 'spork',
    name: 'Spork',
    description: 'Bent tines and a scooped bowl, pressed into service as a folded pick.',
    limitation: 'Works renewable surface rocks. A little undignified, but it gets the job done.',
    iconKey: 'tool.spork',
    family: 'pickaxe',
    tier: 1,
    verb: 'mine',
  ...
  'basic-pickaxe': {
    id: 'basic-pickaxe',
    name: 'Basic Pickaxe',
    description: 'A proper folded pick head, once the spork stops being enough of a joke.',
    limitation: 'A steadier pick for the same renewable surface rocks.',
    iconKey: 'tool.basic-pickaxe',
    family: 'pickaxe',
    tier: 2,
    verb: 'mine',
  },
  'heavyduty-pickaxe': {
    ...
    description: 'A double-headed pick with a bound handle, built to work fast.',
    limitation: 'The strongest pick currently available. Nothing is gated above it yet.',
    iconKey: 'tool.heavyduty-pickaxe',
    family: 'pickaxe',
    tier: 3,
    verb: 'mine',
  },
