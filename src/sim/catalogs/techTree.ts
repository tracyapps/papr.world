...
export const TECH_DEFS = {
  ...
  'water-tending': {
    id: 'water-tending',
    name: 'Water Tending',
    summary: 'Ponds, streams, and lakes as places to look after, not only walk around.',
    branch: 'caring-for-the-land',
    requires: ['digging-2'],
    readiness: 'concept',
  },
  'fishing': {
    id: 'fishing',
    name: 'Fishing',
    summary: 'Patience, a line, and a lot of holding still.',
    branch: 'caring-for-the-land',
    requires: ['water-tending'],
    readiness: 'concept',
    previewGrants: ['A fishing line', 'Fish to watch and catch'],
  },
  'wells-and-springs': {
    id: 'wells-and-springs',
    name: 'Wells & Springs',
    summary: 'Finding water, and then not having to fetch it by hand every time.',
    branch: 'caring-for-the-land',
    requires: ['water-tending'],
    readiness: 'concept',
    previewGrants: ['Wells & pumps', 'Sharing water with neighbours'],
  },
  'gardening-1': {
    id: 'gardening-1',
    name: 'Gardening 1',
  ...
  'dryland-growing': {
    id: 'dryland-growing',
    name: 'Dryland Growing',
    summary: 'Sunpaper and prickly pear: crops that thrive where little else will.',
    branch: 'caring-for-the-land',
    requires: ['seeds-planting'],
    readiness: 'concept',
  },
  'bamboo-cultivation': {
    id: 'bamboo-cultivation',
    name: 'Bamboo Cultivation',
    summary: 'Bamboo starts, tender shoots, and keeping a grove from taking over the garden.',
    branch: 'caring-for-the-land',
    requires: ['growing-food'],
    readiness: 'concept',
    previewGrants: ['Managed bamboo groves'],
  },
  'organic-gardening': {
  ...
  'mining-1': {
    ...
    readiness: 'ready',
    learningHours: 1,
    tasks: [{ kind: 'make', recipeId: 'spork', quantity: 1, weight: 1 }],
    grants: ['spork'],
  },
  'mining-2': {
    id: 'mining-2',
    name: 'Sturdier Picks',
    summary: 'A proper folded pick head, once the spork stops being enough of a joke.',
    branch: 'materials',
    requires: ['mining-1'],
    readiness: 'ready',
    learningHours: 7,
    tasks: [
      { kind: 'own-tool', toolId: 'spork', weight: 1 },
      { kind: 'make', recipeId: 'spork', quantity: 1, weight: 1 },
    ],
    grants: ['basic-pickaxe'],
  },
  'mining-3': {
    id: 'mining-3',
    name: 'Deep-Set Picks',
    summary: 'A double head and a bound handle: the current top rung for renewable surface rock.',
    branch: 'materials',
    requires: ['mining-2'],
    readiness: 'ready',
    learningHours: 20,
    tasks: [
      { kind: 'own-tool', toolId: 'basic-pickaxe', weight: 1 },
      { kind: 'make', recipeId: 'basic-pickaxe', quantity: 2, weight: 2 },
    ],
    grants: ['heavyduty-pickaxe'],
  },
  // Wall/cave mining is a future mechanic, not yet built — these stay concept
  // placeholders. Renumbered off mining-2/mining-3 once those became the real
  // pickaxe tool ladder (mirroring digging-1..3, trimming-1..2, building-1..3).
  'mining-wall-seams': {
    id: 'mining-wall-seams',
    name: 'Wall Mining',
    summary: 'Wall seams, and the rarer materials that only turn up inside them.',
    branch: 'materials',
    requires: ['mining-3'],
    readiness: 'concept',
    previewGrants: ['Wall seams underground'],
  },
  'mining-deep-wall': {
    id: 'mining-deep-wall',
    name: 'Deep Wall Mining',
    summary: 'Landmark deposits and the hardest stone there is.',
    branch: 'materials',
    requires: ['mining-wall-seams', 'digging-3'],
    readiness: 'concept',
    previewGrants: ['Creasebreaker (working name)', 'Landmark deposits'],
  },
  ...
  'foraging': {
    id: 'foraging',
    name: 'Foraging',
    summary: 'Knowing which wild growth is worth taking, and how to take it so it grows back.',
    branch: 'caring-for-the-land',
    requires: ['trimming-1'],
    readiness: 'concept',
    previewGrants: ['Wild-food gathering'],
  },
  'building-1': {
    id: 'building-1',
    name: 'Building 1',
  ...
  // The first three lessons that teach a build piece rather than a tool. They
  // sit off the ready roots (never a concept node) and are deliberately spread
  // across the tree instead of bundled: the arbor rides on gardening, the table
  // on trimming, the bridge on digging. The hammer tier on each piece still
  // applies on top — a plan says you know how, the mallet says you can.
  'garden-structures': {
    id: 'garden-structures',
    name: 'Garden Structures',
    summary: 'Give climbing plants something to climb: a first arbor, built where it will stand.',
    branch: 'caring-for-the-land',
    requires: ['gardening-2', 'building-2'],
    readiness: 'ready',
    learningHours: 9,
    tasks: [
      { kind: 'own-tool', toolId: 'tending-hoe', weight: 1 },
  ...
  'outdoor-furniture': {
    ...
    summary: 'Benches and a table sturdy enough for the whole meadow.',
    branch: 'building-construction',
    requires: ['building-2', 'trimming-2'],
    readiness: 'ready',
    learningHours: 10,
    tasks: [
      { kind: 'own-tool', toolId: 'basic-mallet', weight: 1 },
  ...
  'simple-crossings': {
    ...
    summary: 'Span a stream or a pond with something that folds and holds.',
    branch: 'building-construction',
    requires: ['building-2', 'digging-2'],
    readiness: 'ready',
    learningHours: 14,
    tasks: [
      { kind: 'own-tool', toolId: 'basic-mallet', weight: 1 },
  ...
  'scaffolding': {
    id: 'scaffolding',
    name: 'Scaffolding',
    summary: 'Watching a build go up in stages, and attempting things too big to finish in one sitting.',
    branch: 'building-construction',
    requires: ['building-3'],
    readiness: 'concept',
    previewGrants: ['Visible build scaffolds', 'Larger multi-step structures'],
  },
  'lumber-types': {
    id: 'lumber-types',
    name: 'Lumber Types',
  ...
  'masonry': {
    id: 'masonry',
    name: 'Masonry',
    summary: 'Stone, mortar, and things meant to outlast the person who made them.',
    branch: 'building-construction',
    requires: ['mining-1', 'materials-refinement-1'],
    readiness: 'concept',
    previewGrants: ['Stone & mortar building pieces'],
  },
  'bamboo-working': {
    id: 'bamboo-working',
    name: 'Bamboo Working',
    summary: 'Light, strong, and quick to grow back: a lumber that is not quite lumber.',
    branch: 'building-construction',
    requires: ['lumber-types', 'bamboo-cultivation'],
    readiness: 'concept',
    previewGrants: ['Bamboo build material', 'Bamboo furniture'],
  },
  ...
  'living-decor': {
    id: 'living-decor',
    name: 'Living Decor',
    summary: 'Moss, flowers, and other things that keep growing after you have arranged them.',
    branch: 'interior-design',
    requires: ['interior-design-concepts', 'gardening-2'],
    readiness: 'concept',
    previewGrants: ['Potted plants', 'Flower arrangements'],
  },
  'color-theory-basics': {
  ...
  'basketry': {
    id: 'basketry',
    name: 'Basketry',
    summary: 'Baskets and mats woven from reed, grass, and bamboo strips.',
    branch: 'fine-arts-textiles',
    requires: ['weaving', 'wetland-growing'],
    readiness: 'concept',
    previewGrants: ['Woven baskets', 'Reed mats'],
  },
  mending: {
    id: 'mending',
    name: 'Mending',
  ...
  'regional-cuisine': {
    ...
    summary: 'What each place grows becomes what it eats.',
    branch: 'cooking',
    requires: ['spices-and-flavor', 'wetland-growing', 'dryland-growing'],
    readiness: 'concept',
    previewGrants: ['Dishes built on each biome\'s own crops'],
  },
  grilling: {
    id: 'grilling',
    name: 'Grilling',
  ...
  'wildlife-observation': {
    ...
    summary: 'Sitting still long enough for the neighbours to forget you are there.',
    branch: 'caring-for-the-land',
    requires: ['art-and-design-basics'],
    readiness: 'concept',
    previewGrants: ['Diary field notes'],
  },
  'natural-dyes': {
    id: 'natural-dyes',
    name: 'Natural Dyes',
    summary: 'Colour from petals, bark, and berries.',
    branch: 'fine-arts-textiles',
    requires: ['art-and-design-basics', 'foraging'],
    readiness: 'concept',
    previewGrants: ['Plant dyes', 'Dyed paper'],
  },
  'papermaking': {
    id: 'papermaking',
    name: 'Papermaking',
    summary: 'Turning pulp back into paper: the one material this whole world is made of.',
    branch: 'fine-arts-textiles',
    requires: ['materials-refinement-1', 'art-and-design-basics'],
    readiness: 'concept',
    previewGrants: ['Handmade paper stock'],
  },
  ...
  'boats': {
    id: 'boats',
    name: 'Boats',
    summary: 'Crossing water without swimming, and carrying something while you do.',
    branch: 'transportation',
    requires: ['transportation-basics', 'water-tending'],
    readiness: 'concept',
    previewGrants: ['A canoe or kayak', 'Deep-water crossing'],
  },
  'personal-transport': {
